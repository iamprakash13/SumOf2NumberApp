# SumOf2NumberApp
This sample app demostrates sum of 2 numbers. 


## Getting Started:

+ [Getting started with Flutter](https://link.medium.com/AtIctLNpF1)
+ [Install Flutter](https://flutter.io/get-started/install/)
+ [Official FLutter Page](http://flutter.dev/)
+ [Play with dart code online](https://dartpad.dev/)
+ [Flutter Useful Packages](https://pub.dev/)
...
[Prakash A](https://linktr.ee/dev.codes_)
